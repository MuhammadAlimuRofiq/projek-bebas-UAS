...
try{
    String sql = "SELECT *FROM akun WHERE nim=('"+txtnim.getText()+"')AND pass=('"+txtpassword.getText()+"')";
    java.sql.Connection conn = (Connection)data.koneksi.koneksiDB();
    java.sql.PreparedStatement pst = conn.prepareStatement(sql);
    java.sql.ResultSet rs = pst.executeQuery(sql);
    if(rs.next()){
        if(txtnim.getText().equals(rs.getString("nim"))&&txtpassword.getText().equals(rs.getString("pass"))){
